...
public class NFA { 
    ...
    public NFA(String regexp) {
        this.regexp = regexp;
        m = regexp.length();
        LinkedStack<Integer> ops = new LinkedStack<Integer>(); 
    ...
    public boolean recognizes(String txt) {
        ...
        LinkedBag<Integer> pc = new LinkedBag<Integer>();
        ...
        for (int i = 0; i < txt.length(); i++) {
            ...
            LinkedBag<Integer> match = new LinkedBag<Integer>();
            for (int v : pc) {
                if (v == m) continue;
