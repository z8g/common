 ...
 * or {@link
 * #createStarted(Ticker)} to supply a fake or mock ticker. This allows you to
 ...
 *
 * <p>
 * <b>Warning for Android users:</b> a stopwatch with default behavior may not
 * continue to keep time while the device is asleep. Instead, create one like
 * this:
 *
 * <pre>{@code
...
public class Stopwatch {
     ...
     *
     * <p>
     * <b>Note:</b> the overhead of measurement can be more than a microsecond,
     * so it is generally not useful to specify {@link TimeUnit#NANOSECONDS}
     * precision here.
     *
     * <p>
